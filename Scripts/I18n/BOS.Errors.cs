...
public static class ErrorsExtensions {
    public static string ToLocalizedString(this Errors.StartConnectionAttemptError error) =>
        error switch
        {
            Errors.StartConnectionAttemptError.PlayerConnectionNotFound => "Failed to start a connection attempt: Player not registered on signaling server",
            ...
            Errors.StartConnectionAttemptError.FailedToUpdatePlayerConnection => "Failed to start a connection attempt: Failed to update player info",
    ...
    public static string ToLocalizedString(this Errors.JoinConnectionAttemptError error) =>
        error switch
        {
            Errors.JoinConnectionAttemptError.PlayerConnectionNotFound => "Failed to join a connection attempt: Player not registered on signaling server",
    ...
    public static string ToLocalizedString(this Errors.SendAnswerError error) =>
        error switch
        {
            Errors.SendAnswerError.PlayerConnectionNotFound => "Failed to send an answer: Player not registered on signaling server",
    ...
    public static string ToLocalizedString(this Errors.SendIceCandidateError error) =>
        error switch
        {
            Errors.SendIceCandidateError.PlayerConnectionNotFound => "Failed to send an ice candidate: Player not registered on signaling server",
    ...
    public static string ToLocalizedString(this Errors.EndConnectionAttemptError error) =>
        error switch
        {
            Errors.EndConnectionAttemptError.PlayerConnectionNotFound => "Failed to end a connection attempt: Player not registered on signaling server",
    ...
    public static string ToLocalizedString(this Errors.CreateRoomError error) =>
        error switch
        {
            Errors.CreateRoomError.PlayerConnectionNotFound => "Failed to create a room: Player not registered on signaling server",
            ...
            Errors.CreateRoomError.FailedToUpdatePlayerConnection => "Failed to create a room: Failed to update player info",
    ...
    public static string ToLocalizedString(this Errors.JoinRoomError error) =>
        error switch
        {
            Errors.JoinRoomError.PlayerConnectionNotFound => "Failed to join a room: Player not registered on signaling server",
            ...
            Errors.JoinRoomError.FailedToUpdatePlayerConnection => "Failed to join a room: Failed to update player info",
    ...
    public static string ToLocalizedString(this Errors.ConnectToRoomPlayersError error) =>
        error switch
        {
            Errors.ConnectToRoomPlayersError.PlayerConnectionNotFound => "Failed to connect to room players: Player not registered on signaling server",
    ...
    public static string ToLocalizedString(this Errors.LeaveRoomError error) =>
        error switch
        {
            Errors.LeaveRoomError.PlayerConnectionNotFound => "Failed to leave a room: Player not registered on signaling server",
            ...
            Errors.LeaveRoomError.FailedToUpdatePlayerConnection => "Failed to leave a room: Failed to update player info",
